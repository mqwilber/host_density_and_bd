    ...
    for(l in 1:L){
        for(y in 1:(Y - 1)){
            ...
            if(missing_density[l, y] == 0){
                ...
                omega[l, y] = single_missing_imputation(beta_omega0 + beta_omega_temp*temperature[l, y] + beta_omega_tadpole*tadpole[l, y] + beta_omega_snow*snow[l, y + 1] + beta_omega_tempsnow*temperature[l, y]*snow[l, y + 1],
                                                                      beta_omega_density,
                                                                      density[l, y],
                                                                      sigma_density);


                phi[l, y] = single_missing_imputation(beta_phi0 + beta_phi_temp*temperature[l, y] + beta_phi_tadpole*tadpole[l, y] + beta_phi_snow*snow[l, y + 1] + beta_phi_tempsnow*temperature[l, y]*snow[l, y + 1],
                                                      beta_phi_density,
                                                      density[l, y],
                                                      sigma_density);
