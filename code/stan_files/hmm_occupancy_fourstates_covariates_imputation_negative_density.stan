...
data {
    ...
    real beta_omega0;
    real<lower=0> beta_omega_density;
    real beta_omega_temp;
    real beta_omega_snow;
    real beta_omega_tadpole;
    real beta_omega_tempsnow;
    ...
    real beta_phi0;
    real<lower=0> beta_phi_density;
    real beta_phi_temp;
    real beta_phi_snow;
    real beta_phi_tadpole;
    real beta_phi_tempsnow;
        ...
        for(y in 1:(Y - 1)){
            ...
            if(missing_density[l, y] == 0){
                ...
                omega[l, y] = Phi(beta_omega0 - 
                                        ...
                                        beta_omega_snow*snow[l, y + 1] + // Snow is April 1 in the next year 
                                        beta_omega_tempsnow*temperature[l, y]*snow[l, y + 1] +
                                        beta_omega_tadpole*tadpole[l, y]);
                phi[l, y] = Phi(beta_phi0 - 
                                      beta_phi_density*density[l, y] + 
                                      beta_phi_temp*temperature[l, y] +
                                      beta_phi_snow*snow[l, y + 1] + 
                                      beta_phi_tempsnow*temperature[l, y]*snow[l, y + 1] + 
                ...
                omega[l, y] = tadpole[l, y]*single_missing_imputation(beta_omega0 + beta_omega_temp*temperature[l, y] + beta_omega_tadpole + beta_omega_snow*snow[l, y + 1] + beta_omega_tempsnow*temperature[l, y]*snow[l, y + 1],
                                                                      beta_omega_density,
                                                                      density[l, y],
                                                                      sigma_density) +
                             (1 - tadpole[l, y])*single_missing_imputation(beta_omega0 + beta_omega_temp*temperature[l, y] + beta_omega_snow*snow[l, y + 1] + beta_omega_tempsnow*temperature[l, y]*snow[l, y + 1],
                                                                           beta_omega_density,
                                                                           density[l, y],
                                                                           sigma_density);

                phi[l, y] = tadpole[l, y]*single_missing_imputation(beta_phi0 + beta_phi_temp*temperature[l, y] + beta_phi_tadpole + beta_phi_snow*snow[l, y + 1] + beta_phi_tempsnow*temperature[l, y]*snow[l, y + 1],
                                                      beta_phi_density,
                                                      density[l, y],
                                                      sigma_density) + 
                            (1 - tadpole[l, y])*single_missing_imputation(beta_phi0 + beta_phi_temp*temperature[l, y] + beta_phi_snow*snow[l, y + 1] + beta_phi_tempsnow*temperature[l, y]*snow[l, y + 1],
                                                                          beta_phi_density,
                                                                          density[l, y],
                                                                          sigma_density);
