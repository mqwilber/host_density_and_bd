    ...
    for(l in 1:L){
        for(y in 1:(Y - 1)){
            ...
            if(missing_density[l, y] == 0){
                ...
                omega[l, y] = tadpole[l, y]*single_missing_imputation(beta_omega0 + beta_omega_temp*temperature[l, y] +  beta_omega_temp2*temperature[l, y]^2 + beta_omega_tadpole,
                                                                      beta_omega_density,
                                                                      density[l, y],
                                                                      sigma_density) +
                             (1 - tadpole[l, y])*single_missing_imputation(beta_omega0 + beta_omega_temp*temperature[l, y] + beta_omega_temp2*temperature[l, y]^2,
                                                                           beta_omega_density,
                                                                           density[l, y],
                                                                           sigma_density);

                phi[l, y] = tadpole[l, y]*single_missing_imputation(beta_phi0 + beta_phi_temp*temperature[l, y] + beta_phi_temp2*temperature[l, y]^2 + beta_phi_tadpole,
                                                      beta_phi_density,
                                                      density[l, y],
                                                      sigma_density) + 
                            (1 - tadpole[l, y])*single_missing_imputation(beta_phi0 + beta_phi_temp*temperature[l, y] + beta_phi_temp2*temperature[l, y]^2,
                                                                          beta_phi_density,
                                                                          density[l, y],
                                                                          sigma_density);
